...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const category = (await fetchCategoryBySlug(slug)) as Category | null
...
export default async function CategoryPage({ params, searchParams }: Props) {
  ...
  // Force la catégorie courante dans les filtres
  ...
  const categoryCourses = courses as CourseWithRelations[]
