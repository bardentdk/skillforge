...
export const metadata: Metadata = {
  ...
  description: 'Découvre 500+ cours premium en tech & digital. Du débutant à l\'expert, trouve la formation qui te fera passer au niveau supérieur.',
}
        ...
        <Reveal>
          <div className="text-center max-w-3xl mx-auto mb-10">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight mb-4">
              Trouve ton{' '}
              <span className="text-gradient-emerald">prochain cours</span>
            </h1>
            <p className="text-lg text-muted-foreground">
              {total > 0 ? (
                <>
                  <span className="text-emerald-400 font-semibold">{total} cours</span> en tech & digital,
                  par les meilleurs experts du marché.
                </>
              ) : (
